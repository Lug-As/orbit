	...
	<section class="bloger">
		<div class="container">
			...
			<template v-else-if="(account && Object.keys(account).length !== 0)">
				...
				<message-modal
					:open="showModal"
					:added-text="'Нажимая “Предложить выполнение задачи”, Вы соглашаетесь, что сервис автоматически отправит этому блогеру Ваши контактные данные, чтобы он мог с Вами связаться'"
