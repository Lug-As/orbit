	...
	<section class="offer">
		<div class="container">
			...
			<template v-else-if="(project && Object.keys(project).length !== 0)">
				...
				<message-modal
					:open="showModal"
					:added-text="'Нажимая “Предложить выполнение задачи”, Вы соглашаетесь, что сервис автоматически отправит этому рекламодателю Ваши контактные данные, чтобы он мог с Вами связаться'"
